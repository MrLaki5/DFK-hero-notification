...
def get_hero_recover_list(configuration):
    recovered_hero_status = {}
    user_heros = get_users_heroes(configuration["user_address"], RPC_ADDRESS)
    current_date = datetime.now(timezone.utc)
    for hero in user_heros:
        hero_details = get_hero(hero, RPC_ADDRESS)
